...
import { TrendingUp, DollarSign, Package, Users, Calendar, Star, AlertTriangle, Activity, Zap, Clock, Target, BarChart3 } from 'lucide-react';
...
const Analytics: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Enhanced Inventory Movement Analysis Section */}
      <div className="bg-white rounded-lg shadow-sm p-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="text-sm text-gray-600">
            Product velocity and stock optimization insights
          </div>
        </div>
        ...
        {reorderRecommendations.length > 0 && (
          <div className="mt-6 border border-orange-200 rounded-lg p-4 bg-orange-50">
            <h3 className="text-md font-semibold mb-3 flex items-center">
            ...
            {reorderRecommendations.length > 6 && (
              <div className="mt-3 text-center">
                <p className="text-sm text-orange-700">
                  And {reorderRecommendations.length - 6} more products need reordering...
                </p>
              </div>
            )}
          </div>
        ...
        {/* Movement Analysis Legend */}
        <div className="mt-6 p-4 bg-gray-50 rounded-lg">
          <h4 className="text-sm font-semibold text-gray-900 mb-3">Movement Categories Explained</h4>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 text-xs">
            <div className="flex items-center">
              <Zap className="h-3 w-3 text-green-600 mr-2" />
              <div>
                <div className="font-medium text-green-800">Fast Moving</div>
                <div className="text-gray-600">High demand, quick turnover</div>
              </div>
            </div>
            <div className="flex items-center">
              <Activity className="h-3 w-3 text-blue-600 mr-2" />
              <div>
                <div className="font-medium text-blue-800">Medium Moving</div>
                <div className="text-gray-600">Steady demand, regular turnover</div>
              </div>
            </div>
            <div className="flex items-center">
              <Clock className="h-3 w-3 text-yellow-600 mr-2" />
              <div>
                <div className="font-medium text-yellow-800">Slow Moving</div>
                <div className="text-gray-600">Low demand, consider promotion</div>
              </div>
            </div>
            <div className="flex items-center">
              <AlertTriangle className="h-3 w-3 text-red-600 mr-2" />
              <div>
                <div className="font-medium text-red-800">Dead Stock</div>
                <div className="text-gray-600">No movement, review necessity</div>
              </div>
            </div>
          </div>
        </div>
